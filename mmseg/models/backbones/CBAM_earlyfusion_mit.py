...
class CBAM(nn.Module):
    def __init__(self, gate_channels, reduction_ratio=16, pool_types=['avg', 'max'], no_spatial=False):
        ...
        self.lastconv = BasicConv(128, 64, 1, stride=1, padding=0, dilation=1, groups=1, relu=True, bn=True, bias=False)
...
class CBAMEarlyFusionMixVisionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 with_cp=False):
        super(CBAMEarlyFusionMixVisionTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(CBAMEarlyFusionMixVisionTransformer, self).init_weights()
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.layersRGB):
            ...
            if i == 0:
                xrgb = self.cbam1(torch.cat([xrgb, outsIR[0]], dim=1))            
            if i in self.out_indices:
                outsRGB.append(xrgb)
