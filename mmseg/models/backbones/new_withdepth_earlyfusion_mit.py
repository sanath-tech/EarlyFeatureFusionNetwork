...
class ConcatFuser(nn.Sequential):
...
class Conv(nn.Sequential):
    def __init__(self, in_channels: int, out_channels: int) -> None:
        ...
        self.out_channels = out_channels
        super().__init__(
            nn.Conv2d(in_channels, in_channels,kernel_size=3, stride=1, padding=1, groups=64),
...
class DepthEarlyFusionMixVisionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 with_cp=False):
        super(DepthEarlyFusionMixVisionTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(DepthEarlyFusionMixVisionTransformer, self).init_weights()
