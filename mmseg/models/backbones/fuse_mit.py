...
class InternalMixVisionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 with_cp=False):
        super(InternalMixVisionTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(InternalMixVisionTransformer, self).init_weights()
...
@BACKBONES.register_module()
class RGBTMixVisionTransformer(BaseModule):
    """The backbone of Segformer.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 with_cp=False):
        super(RGBTMixVisionTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(RGBTMixVisionTransformer, self).init_weights()
    ...
    def forward(self, x):
        ...
        outs.append(self.fuser1([outsRGB[0], outsIR[0]]))

        outs.append(self.fuser2([outsRGB[1], outsIR[1]]))

        outs.append(self.fuser3([outsRGB[2], outsIR[2]]))

        outs.append(self.fuser4([outsRGB[3], outsIR[3]]))       
