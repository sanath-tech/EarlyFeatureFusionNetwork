...
model = dict(
    ...
    pretrained=None,
    backbone=dict(
        type='CBAMEarlyFusionMixVisionTransformer',
        in_channels_ir=1,
        in_channels_rgb=3,
        embed_dims=64,
        num_stages=4,
...
data = dict(
    ...
    test=dict(
        type='MFnet_rgbt',
        data_root='data/MFnet',
        img_dir='img_dir/rgbt/test_night',
        ann_dir='ann_dir/test_night',
        pipeline=[
            dict(
                type='LoadImageFromFile',
                imdecode_backend='pillow',
...
work_dir = './work_dirs/CBAM+IR_1*1_teacherattention_earlyfuseformer_mit-b2_4k_32_mfnet_focal_rgbt'
#gpu_ids = [1]
auto_resume = False
